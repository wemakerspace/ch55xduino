...
__code uint8_t Prod_Des[]={                                //Produce String Descriptor
    ...
    'C',0x00,'u',0x00,'b',0x00,'e',0x00,'*',0x00,' ',0x00,
    'X',0x00,'m',0x00,'a',0x00,'s',0x00,' ',0x00,
...
__code uint8_t CDC_Des[]={                            
    0x14,0x03,
    'X',0x00,'m',0x00,'a',0x00,'s',0x00,' ',0x00,'2',0x00,
    '0',0x00,'2',0x00,'0',0x00
};
...
__code uint8_t Manuf_Des[]={
    0x18,0x03,
    'T',0x00,'o',0x00,'m',0x00,'a',0x00,'t',0x00,'o',0x00,
    'C',0x00,'u',0x00,'b',0x00,'e',0x00,'*',0x00,
};
