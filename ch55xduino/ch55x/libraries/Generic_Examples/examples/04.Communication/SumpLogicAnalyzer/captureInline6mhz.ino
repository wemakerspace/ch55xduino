void captureInline6mhz() {
  ...
  sendP11CharDebug('W'); sendP11CharDebug(trigger);
  if (trigger) {
...
#define INLINE_CAPTURE2   __asm__("  mov a,_P1 \n  xchd A,@r0 \n  .db #0xa5 \n" );
  ...
  P3_3 = 1;
  INLINE_CAPTURE1; P3_3 = 0; INLINE_CAPTURE2; P3_3 = 1; INLINE_CAPTURE1; P3_3 = 0; INLINE_CAPTURE2; INLINE_CAPTURE1; INLINE_CAPTURE2; INLINE_CAPTURE1; INLINE_CAPTURE2; //pair 4
  ...
  sendP11CharDebug('R'); sendP11CharDebug(captureSize); sendP11CharDebug(captureSize >> 8);

  for (unsigned int i = 0 ; i < captureSize; i++ ) {
    if (i < 3) {
USBSerial_write(7);
    } else {
USBSerial_write(0);
